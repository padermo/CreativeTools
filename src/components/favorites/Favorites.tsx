...
export default function Favorites() {
  ...
  const [dataReportItem, setDataReportItem] = useState<DataReportItem>({
    id: '',
    name: '',
  });
  ...
  return (
    <div className='flex flex-col w-full min-h-dvh max-h-full gap-4 justify-center items-center py-8'>
      <div
        className='w-full flex flex-wrap gap-5 flex-1'
        style={{
          justifyContent:
            favoriteItems !== undefined && favoriteItems.length > 2
              ? 'space-between'
              : 'normal',
        }}
      >
